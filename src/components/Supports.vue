  ...
  <div class="content">
    <div class="card">
      <div class="commentContent main">
        <span class="avatar">
          <img :src="require('@/assets/images/avatars/user01.svg')" alt="" />
        </span>
        <span class="comment">
          <div class="balloon">
    ...
    <div class="card">
      ...
      <div class="answersContent">
        <div class="commentContent rightContent">
          ...
          <span class="avatar">
            <img :src="require('@/assets/images/avatars/user03.svg')" alt="" />
          </span>
        </div>
    ...
    <div class="card">
      <div class="commentContent main">
        <span class="avatar">
          <img :src="require('@/assets/images/avatars/user02.svg')" alt="" />
        </span>
        <span class="comment">
          <div class="balloon">
            <span class="fas fa-sort-down"></span>
